...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["The more you know",					"Clear the Tutorial",							'Tutorial_clear',			false],
		["You've unlocked your demise",			"It get's harder...",							'Hell_unlock',				false],
		["Triple Victory ",						"Clear Crossed out on Normal.",					'CrossedOut_Normal_clear',	false],
		["Triple Triumph ",						"Clear Crossed out on Hard.",					'CrossedOut_Hard_clear',	false],
		["Ultimate Triumph",					"Clear Crossed out on Hell.",					'CrossedOut_Hell_clear',	true],
		["Funkin Pro",							"Clear Crossed out on Normal with no Misses.",	'CrossedOut_Normal_nomiss',	false],
		["Funkin Veteran",						"Clear Crossed out on Hard with no Misses.",	'CrossedOut_Hard_nomiss',	false],
		["Funkin God",							"Clear Crossed out on Hell with no Misses.",	'CrossedOut_Hell_nomiss',	true]
		//["A wall of Giga Chads",				"Find the secret in the Tutorial!",				'tutorial_secret',			false],
		//["What the fyck is wrong with you?",	"Why whould anyone ever do that?",				'tutorial_supersecret',		 true]
	];
